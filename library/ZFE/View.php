 ...
 * @method string formClearfix($name, $value = null, $attribs = null)
 * @method string formDatelist($name, $value = null, $attribs = null)
 * @method string formDuration($name, $value = null, $attribs = null)
