 ...
 * @method void Download(string $path, string $url, string $name, bool $download = true)                        Отправить файл средствами сервера через авторизацию приложения
 * @method void DownloadApache(string $path, string $name, bool $download = true)                               Отправить файл средствами Apache через авторизацию приложения
 * @method void DownloadNginx(string $path, string $url, string $name, bool $download = true)                   Отправить файл средствами nginx через авторизацию приложения
 * @method void DownloadPhp(string $path, string $url, string $name, bool $download = true)                     Отправить файл средствами PHP через авторизацию приложения
